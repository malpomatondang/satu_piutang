<x-main-layout>
    <div class="app-content-header"> <!--begin::Container-->
                    <div class="container-fluid"> <!--begin::Row-->
                        <div class="row">
                            <div class="col-sm-6">
                                <h3 class="mb-0">Net Relizable Value</h3>
                            </div>
                            <div class="col-sm-6">
                    ...
                    <div class="container-fluid"> <!--begin::Row-->
                        <div class="row">
                            <div class="col-md-12">
                                <div class="card mb-4">
                                    <div class="card-header">
                                        <h3 class="card-title">Net Relizable Value Pajak</h3>
                                    </div> <!-- /.card-header -->
                                        ...
                                        <table class="table table-bordered">
                                            ...
                                            <tbody>
                                                ...
                                                <tr class="align-middle">
                                                    ...
                                                    <td>{{ number_format($piutang_pajak_pusat->saldo_piutang - $piutang_pajak_pusat->penyisihan_piutang) }}</td>
                            ...
                            <div class="col-md-12">
                                <div class="card mb-4">
                                    <div class="card-header">
                                        <h3 class="card-title">Net Relizable Value Non Pajak</h3>
                                    </div> <!-- /.card-header -->
                                    <div class="card-body table-responsive">
                                        <table class="table table-bordered">
                                            <thead>
                                            ...
                                            <tbody>
                                                ...
                                                <tr class="align-middle">
                                                    ...
                                                    <td>{{ number_format($piutang_pajak_pusat->penyisihan_piutang) }}</td>
                                                    <td>{{ number_format($piutang_non_pajak->saldo_piutang - $piutang_pajak_pusat->penyisihan_piutang) }}</td>
                            ...
                            <div class="col-md-12">
                                <div class="card mb-4">
                                    <div class="card-header">
                                        <h3 class="card-title">NET REALIZABLE VALUE Pemda</h3>
                                    </div> <!-- /.card-header -->
                                    <div class="card-body table-responsive">
                                        <table class="table table-bordered">
                                            <thead>
                                            ...
                                            <tbody>
                                                ...
                                                <tr class="align-middle">
                                                    ...
                                                    <td>{{ number_format($piutang_pajak_pusat->penyisihan_piutang) }}</td>
                                                    <td>{{ number_format($piutang_pajak_daerah->saldo_piutang - $piutang_pajak_pusat->penyisihan_piutang) }}</td>
